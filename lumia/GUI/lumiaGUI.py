...
def callLumiaGUI(ymlFile,  scriptDirectory, iVerbosityLv=1): 
    ...
    (bFirstGuiPageSuccessful, ymlContents)=LumiaGuiPage1(sLogCfgPath, ymlContents, ymlFile, iVerbosityLv=1) 
    # TODO: for now, test the first page only for the new GUI engines & layout
    bFirstGuiPageSuccessful=False
    if(bFirstGuiPageSuccessful):
...
# LumiaGui Class =============================================================
class LumiaTkGui(tk.Frame):
    def __init__(self, parent, *args, **kwargs):
        tk.Frame.__init__(self, parent, *args, **kwargs)
        self.parent = parent

#class LumiaTkGui(ctk.CTk, root):  #ctk.CTk):
    # =====================================================================
    # The layout of the window will be written
    # in the init function itself
   # def __init__(self, root):  # *args, **kwargs):
        #ctk.CTk.__init__(self, root)  # ctk.CTkToplevel.__init__(self, root)
        #self.parent = root
    #    root.title('LUMIA - the Lund University Modular Inversion Algorithm')  

# =======================================================================
def LumiaGuiPage1(sLogCfgPath, ymlContents, ymlFile, iVerbosityLv=1): 
    # =====================================================================
    ...
    def show(guiPage1):
        if(USE_TKINTER):
            #guiPage1.wm_protocol("WM_DELETE_WINDOW", guiPage1.parent.destroy)
            try:
                guiPage1.parent.wm_protocol("WM_DELETE_WINDOW", guiPage1.parent.destroy)
            except:
                pass
    ...
    if(USE_TKINTER):
        ...
        root=ctk.CTk()
        guiPage1=LumiaTkGui(root) # .pack(side="top", fill="both", expand=True)
        
        #guiPage1=None
        #LumiaTkGui(guiPage1)
        # guiPage1.attributes('-topmost', 'true')
        # guiPage1.parent = root
        guiPage1.grid_rowconfigure(0, weight=1)
        guiPage1.columnconfigure(0, weight=1)
        guiPage1.activeTextColor='gray10'
        guiPage1.inactiveTextColor='gray50'
    else:
    ...
    # Row 0:  Title Label
    # ################################################################
    guiPage1.TitleLabel = ge.guiTxtLabel(guiPage1, "LUMIA  --  Configure your next LUMIA run",  
                                                                fontName=guiPage1.myFontFamily, fontSize=fsGIGANTIC)
    # Row 12
    # ################################################################
    # Cancel Button
