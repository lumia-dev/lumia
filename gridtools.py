...
def grid_from_rc(rcf, name=None):
    ...
    lon0 = rcf.getAlt(pfx0, 'lon0', default=rcf.getAlt(pfx1, 'lon0', default=None))
    lon1 = rcf.getAlt(pfx0, 'lon1', default=rcf.getAlt(pfx1, 'lon1', default=None))
    dlon = rcf.getAlt(pfx0, 'dlon', default=rcf.getAlt(pfx1, 'dlon', default=None))
    nlon = rcf.getAlt(pfx0, 'nlon', default=rcf.getAlt(pfx1, 'nlon', default=None))
    lat0 = rcf.getAlt(pfx0, 'lat0', default=rcf.getAlt(pfx1, 'lat0', default=None))
    lat1 = rcf.getAlt(pfx0, 'lat1', default=rcf.getAlt(pfx1, 'lat1', default=None))
    dlat = rcf.getAlt(pfx0, 'dlat', default=rcf.getAlt(pfx1, 'dlat', default=None))
    nlat = rcf.getAlt(pfx0, 'nlat', default=rcf.getAlt(pfx1, 'nlat', default=None))
